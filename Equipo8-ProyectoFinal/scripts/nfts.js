...
async function createImgInfo() {
    ...
    const stream = fs.createReadStream("./images/equipo11.jpg")
...
async function createJsonInfo() {
    const metadata = {
        image: "https://gateway.pinata.cloud/ipfs/QmWGHrjomqqfn2azRkL2S3Fbe2bxZ6MfGkmncG7qexEccq",
        name: "NFT para Equipo 11",
        description: "NFT de parte del equipo 8: alumno captado en camara dormido en clase de Pineda",
        attributes: [
...
async function mintNFT() {
    ...
    const transaction = {
        ...
        data: etherInterface.encodeFunctionData("mintNFT",
            [PUBLIC_KEY, "https://gateway.pinata.cloud/ipfs/QmcGYv8Qx8MsRDEoLq4fkXD6jG4Lyfbp8Rnb4YY25UJe1Q"])
    }
